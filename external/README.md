...
├── MS-SNSD/               # Raw MS-SNSD dataset
├── VOiCES/                # Raw VOiCES dataset
└── Voicebank28/           # Raw VoiceBank+DEMAND dataset
...
## Model Repositories
### NAS-VAD
- Repository: https://github.com/daniel03c1/NAS_VAD
- Used as the **main training framework** in this project

### Self-Attentive VAD
- Repository: https://github.com/voithru/voice-activity-detection
